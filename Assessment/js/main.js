...
/*************************************************************************************
 console.log(x) undifined becouse variable is not defined yet so it has nothing to refrence.
 console.log(foo()) becouse hoisting read the funcetions as if they were to the top so it can log it.
...
//console.log(add);
/**************************************************************************************
Inside of the IFEE 4 will console log becouse the variable is set inside of the IFEE

Outside it will be undefined becouse it is declared inside of the IFFE not globaly.
